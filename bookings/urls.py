...
urlpatterns = [
    ...
    path("confirm/<int:booking_id>/", views.confirm_booking,
         name="confirm_booking"),
    path("decline/<int:booking_id>/", views.decline_booking,
         name="decline_booking"),
    path("admin-dashboard/", views.admin_booking_dashboard,
    ...
    path("admin/bookings/delete/<int:booking_id>/", views.admin_delete_booking,
